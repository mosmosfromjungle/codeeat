...
import { fetchRoomList } from '../../apicalls/DM';
import ClearIcon from '@mui/icons-material/Close';
import Cookies from 'universal-cookie';
import { setRequestFriendCnt } from '../../stores/DMboxStore';
...
export default function FriendRequest(props) {
  ...
  const username = useAppSelector((state) => state.user.username) || cookies.get('userName');
...
const MyButton = styled.button<MyButtonProps>`
  ...
  &:hover {
    background-color: ${(props) => (props.hoverColor ? props.hoverColor : 'blue')};
  }
`;
